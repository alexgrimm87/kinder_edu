...
$(document).ready(function(){
   ...
   validate('.activation-form', {submitFunction:validationCall1});
   validate('#sms-popup .sms-form', {submitFunction:validationCall2});
   validate('.contacts-form', {submitFunction:validationCall1});
   validate('.connection-form', {submitFunction:validationCall1});
